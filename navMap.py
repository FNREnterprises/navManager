...
def buildImageName(x, y, yaw=None, pitch=None):
    ...
    :return: <rounded, signed x>_<rounded signed y>_<rounded signed yaw>_<rounded signed pitch>
    """
...
def takeCartcamImage(show=False):
    ...
    # [<requestingProcess>,<requestType>,<cam-id>,<markerlist(empty list for any)>,optional<imageFile>]
